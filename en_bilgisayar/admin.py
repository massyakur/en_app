...
class AllAdmin(admin.ModelAdmin):
    list_display = ('item_name','item_brand', 'item_model_number', 'item_rating','item_price', 'item_site_name')
    search_fields = ('item_name', 'item_brand')
    list_filter = ('item_brand', 'item_operating_system', 'item_ram', 'item_disk_type', 'item_disk_size', 'item_screen_size', 'item_rating', 'item_site_name')
